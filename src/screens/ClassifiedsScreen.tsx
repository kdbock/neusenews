...
import fetchRSSFeed from "../utils/fetchRSSFeed"; // Removed Article type import

export default function ClassifiedScreen() {
  const [articles, setArticles] = useState([]); // Removed type annotation
  const [loading, setLoading] = useState(true);

  useEffect(() => {
    fetchRSSFeed("https://www.neusenews.com/index/category/Classifieds?format=rss")
      .then((data) => {
        setArticles(data);
        setLoading(false);
      })
