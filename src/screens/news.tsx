...
export default function NewsScreen() {
    ...
    // Handle possible string | stringfrom route params
    const params = useLocalSearchParams(); // Use expo-router
    const feedUrlParam = params.rssUrl;     // Use expo-router
    ...
    const openShareLink = (platform: string, url: string) => {
        ...
        switch (platform) {
            case "facebook":
                ...
                break;
            case "twitter":
                shareUrl = `https://twitter.com/intent/tweet?url=<span class="math-inline">\{encodedUrl\}&text\=</span>{text}`;
                break;
            case "reddit":
                shareUrl = `https://www.reddit.com/submit?url=<span class="math-inline">\{encodedUrl\}&title\=</span>{text}`;
                break;
            default:
                shareUrl = url;
                break;
